...
<html>
    ...
    <body>
        ...
        <div class='content d-flex flex-column align-items-center' style = 'margin:20vh 0px'>
            <h1 class='m-5 text-center'  style='width:220px;'> Sign up</h1>
            <form action='/register' method="POST" class='d-flex flex-column align-items-center'>
                @csrf
                <input type="text" id='name' name='name' placeholder="Name" class='mb-1' style='width:220px;'>
                ...
                <input type='password' id='confirm password' name='re-password' placeholder="Repeat password" class='mb-3' style='width:220px;'>
                <button type="submit" class='btn btn-primary' style='width:220px;'>Sign up</button>
            </form>
